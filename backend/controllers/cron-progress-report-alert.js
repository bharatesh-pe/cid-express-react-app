...
//         const template = await Template.findOne({ where: { table_name: "pt_case" } });
...
//         for (const caseEntry of allCases) {
//             const case_id = caseEntry.id;
//             var trial_today = false;
//             var trial_tomorrow = false;
//             var trial_this_week = false;
//             var trial_next_week = false;
...
//                         trial_next_week = true;
//                     }
//                     else if (nextHearingDate.isSame(today.add(1, 'week'), 'week')) {
//                         trial_this_week = true;
//                     }
//                 }
//             } 
//             else {
