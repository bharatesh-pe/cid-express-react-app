                                            ...
                                            <Grid container py={2}>
                                                {
                                                    Object.keys(selectedField).map((prop) => {
                                                        ...
                                                        const increment = (prop === 'required' || prop === 'disabled' || prop === 'history' || prop === 'minDate' || prop === 'maxDate' || prop === 'multiple' || prop === 'table_display_content' || prop === 'is_primary_field'  || prop === 'particular_case_option') ? 2 : 5;
                                                        ...
                                                        if (prop === 'required' || prop === 'disabled' || prop === 'history' || prop === 'minDate' || prop === 'maxDate' || prop === 'multiple' || prop === 'table_display_content' || prop === 'is_primary_field' || prop === 'duplicateCheck' || prop === 'hide_from_ux' || prop === 'particular_case_option') {
                                                            rowColValue = 2;
                                                            ...
                                                            if(prop === 'minDate'){
                                                                ...
                                                                colText = 'Hide in UX'
                                                            }else if(prop === 'particular_case_option'){
                                                                colText = 'Particular Case Option'
                                                            }
                                                        }
                                                            ...
                                                            <>
                                                                <Grid key={prop} item xs={12} md={rowColValue} px={2} py={1}>
                                                                    {prop === 'col' ? null :
                                                                        ...
                                                                        prop === 'hide_from_ux' || prop === 'required' || prop === 'disabled' || prop === 'history' || prop === 'minDate' || prop === 'maxDate' || prop === 'multiple' || prop === 'table_display_content' || prop === 'is_primary_field' || prop === 'duplicateCheck' || prop === 'particular_case_option' ? (
