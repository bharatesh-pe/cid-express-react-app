...
import { Box, Typography, Button, InputAdornment, IconButton, Checkbox } from '@mui/material';
        ...
        <>
            <Box p={2} inert={loading ? true : false}>
                <Box p={2}>
                    {showMasters ? (
                        <Box>
                            <Typography className='Roboto' sx={{ fontSize: '20px', fontWeight: '600', color: '#1D2939' }}>
                                Masters
                            </Typography>
                            {masters.map((master) => (
                                <Box key={master.masters_meta_id} display="flex" alignItems="center" mb={1}>
                                    <Checkbox onClick={() => handleCheckboxClick(master)} />
                    ...
                    <Box>
                        <Typography className='Roboto' sx={{ fontSize: '20px', fontWeight: '600', color: '#1D2939' }}>{selectedMasters}</Typography>
                    </Box>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                    ...
                                    <Button
                                        ...
                                        startIcon={<AddIcon sx={{ border: '1.3px solid #101828', borderRadius: '50%' }} />}
                                        variant="contained"
                                    >
                                        Add New
                                    </Button>
