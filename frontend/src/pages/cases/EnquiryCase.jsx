...
export default function EnquiryCase() {
  ...
  var ShowModalBox = () => {
    setSnackbarMessage(`Enquiry case Saved Successfully..`);
    setSnackbarSeverity('success');
    setOpenSnackbar(true);
    setSuccessVisible(true)
  }
  var DraftModalBox = () => {
    setSnackbarMessage(`Enquiry case Drafted Successfully..`);
    setSnackbarSeverity('success');
    setOpenSnackbar(true);
