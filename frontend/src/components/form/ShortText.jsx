...
// import InfoIcon from '@mui/icons-material/Info';  // Import InfoIcon for tooltip
// import './ShortText.css';

// const ShortText = ({ field, formData, errors, onChange, onFocus, isFocused }) => {
//   return (
//     <div style={{width: '100%'}}>
...
//           <>
//             {field.label}
//             <span className="anekKannada">{field.kannada}</span>
