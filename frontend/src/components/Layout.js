...
const icons = {
    dashboard: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.5 17.5H5.16667C4.23325 17.5 3.76654 17.5 3.41002 17.3183C3.09641 17.1586 2.84144 16.9036 2.68166 16.59C2.5 16.2335 2.5 15.7668 2.5 14.8333V2.5M5.83333 8.75V14.5833M9.58333 4.58333V14.5833M13.3333 8.75V14.5833M17.0833 4.58333V14.5833" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    ),
    user_mgnt: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.6668 17.5V15.8333C16.6668 14.9493 16.3156 14.1014 15.6905 13.4763C15.0654 12.8512 14.2176 12.5 13.3335 12.5H6.66683C5.78277 12.5 4.93493 12.8512 4.30981 13.4763C3.68469 14.1014 3.3335 14.9493 3.3335 15.8333V17.5M13.3335 5.83333C13.3335 7.67428 11.8411 9.16667 10.0002 9.16667C8.15921 9.16667 6.66683 7.67428 6.66683 5.83333C6.66683 3.99238 8.15921 2.5 10.0002 2.5C11.8411 2.5 13.3335 3.99238 13.3335 5.83333Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    ),
    template: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6.66667 12.5V14.1667M10 9.16667V14.1667M13.3333 5.83333V14.1667M6.5 17.5H13.5C14.9001 17.5 15.6002 17.5 16.135 17.2275C16.6054 16.9878 16.9878 16.6054 17.2275 16.135C17.5 15.6002 17.5 14.9001 17.5 13.5V6.5C17.5 5.09987 17.5 4.3998 17.2275 3.86502C16.9878 3.39462 16.6054 3.01217 16.135 2.77248C15.6002 2.5 14.9001 2.5 13.5 2.5H6.5C5.09987 2.5 4.3998 2.5 3.86502 2.77248C3.39462 3.01217 3.01217 3.39462 2.77248 3.86502C2.5 4.3998 2.5 5.09987 2.5 6.5V13.5C2.5 14.9001 2.5 15.6002 2.77248 16.135C3.01217 16.6054 3.39462 16.9878 3.86502 17.2275C4.3998 17.5 5.09987 17.5 6.5 17.5Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    ),
    masters: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2.08317 9.99992H4.90148C5.47248 9.99992 5.99448 10.3225 6.24984 10.8333C6.5052 11.344 7.02719 11.6666 7.5982 11.6666H12.4015C12.9725 11.6666 13.4945 11.344 13.7498 10.8333C14.0052 10.3225 14.5272 9.99992 15.0982 9.99992H17.9165M7.47197 3.33325H12.5277C13.4251 3.33325 13.8738 3.33325 14.2699 3.46989C14.6202 3.59072 14.9393 3.78792 15.204 4.04721C15.5034 4.34042 15.7041 4.74175 16.1054 5.5444L17.9109 9.15534C18.0684 9.47032 18.1471 9.62782 18.2027 9.79287C18.252 9.93946 18.2876 10.0903 18.309 10.2435C18.3332 10.4159 18.3332 10.592 18.3332 10.9442V12.6666C18.3332 14.0667 18.3332 14.7668 18.0607 15.3016C17.821 15.772 17.4386 16.1544 16.9681 16.3941C16.4334 16.6666 15.7333 16.6666 14.3332 16.6666H5.6665C4.26637 16.6666 3.56631 16.6666 3.03153 16.3941C2.56112 16.1544 2.17867 15.772 1.93899 15.3016C1.6665 14.7668 1.6665 14.0667 1.6665 12.6666V10.9442C1.6665 10.592 1.6665 10.4159 1.69065 10.2435C1.71209 10.0903 1.7477 9.93946 1.79702 9.79287C1.85255 9.62782 1.9313 9.47032 2.0888 9.15534L3.89426 5.5444C4.29559 4.74174 4.49625 4.34042 4.79562 4.04721C5.06036 3.78792 5.37943 3.59072 5.72974 3.46989C6.12588 3.33325 6.57458 3.33325 7.47197 3.33325Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    ),
    circular: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1120_40227)">
                <path d="M18.2671 11.0542C18.3107 10.709 18.3332 10.3572 18.3332 10.0001C18.3332 5.39771 14.6022 1.66675 9.99984 1.66675C5.39746 1.66675 1.6665 5.39771 1.6665 10.0001C1.6665 14.6025 5.39746 18.3334 9.99984 18.3334C10.3627 18.3334 10.7201 18.3102 11.0707 18.2652M9.99984 5.00008V10.0001L13.1151 11.5577M15.8332 18.3334V13.3334M13.3332 15.8334H18.3332" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </g>
            <defs>
          ...
          <Paper sx={{ height: "100vh", borderRadius: "0", boxShadow: "none" }}>
            ...
            <List sx={{ padding:'4px', height: "100vh", overflow: 'auto' }}>
              {/* 1st menu list */}
                <Box
                    py={0.5}
                    sx={{ display: "flex", flexDirection: "column", gap: "4px", paddingBottom: '150px' }}
                >
                {sidebarMenusObj &&
